                ...
                <div className="kt-portlet__head-actions">
                      {numSelected > 0 ? (
                          ...
                          <div className="btn-group">
                            <Link to={"/admin/apu/asset/create"} className="btn btn-sm btn-brand btn-elevate btn-icon-sm new-record">
  ...
  function loadDatatable() {
    ...
    let columnDefs = [
      ...
      },
      {
        ...
        "createdCell": function (td, cellData, rowData, row, col) {
          ReactDOM.render(
          <a style={{ cursor: 'pointer', minHeight:'38px', width:'100%', float:'left' }} onClick={() => history.push("/admin/apu/asset/"+rowData.id) }>
          {cellData}
          </a>
              , td
          );
      ...
      },
      {
        ...
        "createdCell": function (td, cellData, rowData, row, col) {
          ...
          defaultValue = '';
          return <option selected={defaultValue} key={i}>{val.label}</option>
        })}
          </Form.Control>
              , td
          );
      ...
      columnDefs.push(
          {
            ...
            "createdCell": function (td, cellData, rowData, row, col) {
              ...
              {permission.edit ? <Dropdown.Item onClick={() => history.push("/admin/apu/asset/"+rowData.id+"/edit") }><i className="flaticon2-edit"></i> Edit Details</Dropdown.Item>:''}
  ...
  return (
    ...
    <div className={classes.root}>
      ...
      <Modal show={showEmail} onHide={handleEmailModalClose} centered>
        <Modal.Header closeButton>
          <Modal.Title>Send mail to revise</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <textarea rows="5" onChange={(e)=> setReason(e.target.value)} style={{display:'block', width: "100%"}}/>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="success" onClick={() => handleEmailModalClose('send')}>
            Send
          </Button>
