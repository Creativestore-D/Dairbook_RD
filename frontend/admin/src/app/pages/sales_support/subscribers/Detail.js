          ...
          <Grid container spacing={3}>
                <Grid item xs={12} md={9}>
                  ...
                  <Form.Group>
                    ...
                    <Form.Label style={this.txt_weight}>{subscriber.name}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Email</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{subscriber.email}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Comments</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{subscriber.comments}</Form.Label>
                  </Form.Group>
                  <Form.Group>
