        ...
        <div>
          <Grid container spacing={3}>
                <Grid item xs={12} md={9}>
                  <Form>
                  <Form.Group>
                    <Form.Label>Message Type</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{messageType}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Subject</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{emailTemplate.subject}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Sending Email</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{emailTemplate.sending_email}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Message</Form.Label><br/>
                    <Form.Label style={this.txt_weight} dangerouslySetInnerHTML={{__html: emailTemplate.message}}/>
                  </Form.Group>
                  <Form.Group>
