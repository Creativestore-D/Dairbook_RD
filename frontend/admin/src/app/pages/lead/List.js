                ...
                <div>
                  <table className="table table-striped- table-bordered table-hover table-checkable" id={"lead"}>
                      ...
                      <tr>
                          ...
                          <th data-data="creator__contact__first_name">Contact</th>
                          <th data-data="creator__contact__company__name">Company</th>
                    ...
                    <Grid item xs={12}>
                        <List >
                            ...
                            <ListItem>
                              <ListItemText
                                primary="Company"
                                secondary={rows[userIndex].leadable && rows[userIndex].leadable.contact.company ? rows[userIndex].leadable.contact.company.name: ''}
                              />
                            </ListItem>
                            <Divider />
                            <ListItem>
