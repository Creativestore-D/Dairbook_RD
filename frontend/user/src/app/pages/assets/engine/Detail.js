                ...
                <Grid item xs={12} md={9}>
                  ...
                  <Form.Row>
                    <Form.Group as={Col} md="6" xs="12">
                      ...
                      <Form.Label style={this.txt_weight}>{engine.company ? engine.company.name: '-----'}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Manfacturer</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.manfacturer ? engine.manfacturer.name: ''}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                    ...
                    <Form.Group as={Col} md="6" xs="12">
                      ...
                      <Form.Label style={this.txt_weight}>{engine.address ? engine.address : '-----'}</Form.Label>
                    </Form.Group>
                  </Form.Row>
                  <Form.Row>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Current Location</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.mobile_phone ? engine.mobile_phone : '-----'}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Type</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.business_phone ? engine.business_phone : '-----'}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Offer For</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.skype ? engine.skype : '-----'}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Primary Contact</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.linkedin ? engine.linkedin : '-----'}</Form.Label>
                    </Form.Group>
                  </Form.Row>
                  <hr/>
                  <Form.Row>
                    <Form.Group as={Col} md="6" xs="12">
                      ...
                      <Form.Label style={this.txt_weight}>{engine.views ? engine.views : '-----'}</Form.Label>
                    </Form.Group>
                    <Form.Group as={Col} md="6" xs="12">
                      <Form.Label>Likes</Form.Label><br/>
                      <Form.Label style={this.txt_weight}>{engine.is_published ? engine.is_published : '-----'}</Form.Label>
                    </Form.Group>
                  </Form.Row>
                  <Form.Row>
                    <Form.Group as={Col} md="6" xs="12">
                  ...
                  <Form.Row>
                    ...
                    <Form.Group>
                      <Link to={"/"+USER_URL+"/engine/asset/"+engine.id+"/edit"} className="btn btn-primary">
