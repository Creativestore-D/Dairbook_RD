                ...
                <div className="kt-portlet__head-actions">
                      {numSelected > 0 ? (
                          ...
                          <div className="btn-group">
                            <Link to={"/"+USER_URL+"/part/asset/create"} className="btn btn-sm btn-brand btn-elevate btn-icon-sm new-record">
  ...
  function loadDatatable() {
    ...
    let columnDefs = [
      ...
      },
      {
        ...
        "createdCell": function (td, cellData, rowData, row, col) {
          ReactDOM.render(
          <a onClick={() => history.push("/"+USER_URL+"/part/asset/"+rowData.id) }>
          {cellData}
          </a>
              , td
          );
