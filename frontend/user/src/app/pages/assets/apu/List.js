...
import {list, patch, del, STATUSES, USER_URL, API_URL, LOCAL_STORAGE} from "../../../crud/api";
...
const EnhancedTableToolbar = props => {
  ...
  const { setPlanModalDisplay, numSelected, type, selected, setSelected, setSelectedMany, setRowsData, rows, setTemp } = props;
                ...
                <div className="kt-portlet__head-actions">
                      {numSelected > 0 ? (
                          ...
                          <div className="btn-group">
                            <span onClick={(e) => handlePlanModal(e)} className="btn btn-sm btn-brand btn-elevate btn-icon-sm new-record">
  ...
  function loadDatatable() {
    ...
    let columnDefs = [
      ...
      },
      {
        ...
        "createdCell": function (td, cellData, rowData, row, col) {
          ReactDOM.render(
          <a onClick={() => history.push("/"+USER_URL+"/apu/asset/"+rowData.id) }>
          {cellData}
          </a>
              , td
          );
        ...
        searchable:false,
          "createdCell": function (td, cellData, rowData, row, col) {
              ...
              <Dropdown.Toggle as={ActionsDropdownToggle} />
                  ...
                  <Dropdown.Item onClick={() => history.push("/"+USER_URL+"/apu/asset/"+rowData.id+"/edit") }><i className="flaticon2-edit"></i> Edit Details</Dropdown.Item>
    ...
    if(action == 'status') {
      ...
      patch('apus/'+rows[userIndex].id+'/', data).then(function (response) {
        ...
        setModalDisplay(false);
          updateTable();
        setOpen(true);
        const statusType = response.data.is_active_by_user === 1 ? 'activated' : 'deactivated';
    ...
    <div className={classes.root}>
      ...
      <Paper className={classes.paper}>
        ...
        <div className="kt-portlet kt-portlet--mobile">
            <EnhancedTableToolbar setTemp={setTemp} setRowsData={setRowsData} rows={rows} setSelectedMany={setSelectedMany} setSelected={setSelected} selected={selected} numSelected={selected.length} type={type} setPlanModalDisplay={setPlanModalDisplay} />
          <div className="kt-portlet__body">
            ...
            <div className="kt-section">
                <div>
                  <table className="table table-striped- table-bordered table-hover table-checkable" id={"apu"}>
                      <thead>
                      <tr>
      ...
      <PlanModal type={'apu'} data={props} modal_display={modal_display} setPlanModalDisplay={setPlanModalDisplay} />
       <Snackbar
          anchorOrigin={{
            vertical: 'top',
            horizontal: 'right',
