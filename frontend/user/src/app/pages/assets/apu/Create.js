...
import {
    list, post, API_URL, getToken, USER_URL, ENGINE_STATUSES, ENGINE_OFFER,
...
import {createMuiTheme, Divider, FormControl, IconButton, Select as SelectCore} from "@material-ui/core";
...
class Create extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            validated: false,
            apu: {is_featured: this.props.data.extra_data.is_featured_aircraft ? this.props.data.extra_data.is_featured_aircraft : 0},
            selectedFile: null,
            category: [],
            manufacturer: [],
            countries: [],
    ...
    selectChange(value, key) {
        let apu = this.state.apu;
        apu[key] = value.value;
        this.setState({['selected_' + key]: value, apu: apu});
